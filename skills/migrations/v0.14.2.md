...
feature_pitch:
  ...
  description: |
    ...
    sync, import, extract, migrate, and every orchestrator. v0.14.2
...
# v0.14.2 Migration: Bulk-action progress streaming

**Audience: host agents reading this after `gbrain apply-migrations`
has run. v0.14.2 is purely additive to the CLI surface, there is no
...
from v0.14.2, additive changes only.
...
The `embed` Minion handler is wired as of v0.14.2. Other bulk cores
